...
export const en: TranslationKeys = {
  ...
  sessions: {
    ...
    closeButton: "Close",
    switchButton: "Switch",
    chooseSwitch: "Switch agent for {project}:",
    switched: '✅ Switched "{project}" → {agent}',
    switchFailed: 'Failed to switch agent for "{project}"',
    noAgentsToSwitch: "No other agents configured to switch to",

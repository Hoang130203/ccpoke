...
export const vi: TranslationKeys = {
  ...
  sessions: {
    ...
    chatButton: "Chat",
    closeButton: "Đóng",
    switchButton: "Đổi CLI",
    chooseSwitch: "Chọn agent để chuyển cho {project}:",
    switched: '✅ Đã chuyển "{project}" → {agent}',
    switchFailed: 'Chuyển agent thất bại cho "{project}"',
    noAgentsToSwitch: "Không có agent nào khác để chuyển",
